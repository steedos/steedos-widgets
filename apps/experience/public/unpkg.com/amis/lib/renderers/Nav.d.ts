...
declare const ThemedNavigation: {
    new (props: Pick<Omit<NavigationProps, keyof ThemeProps>, "hidden" | "$ref" | "disabled" | "disabledOn" | "hiddenOn" | "visible" | "visibleOn" | "id" | "onEvent" | "render" | "env" | "data" | "source" | "itemBadge" | "loading" | "reload" | "draggable" | "deferApi" | "onSelect" | "onToggle" | "itemActions" | "saveOrderApi" | "links" | "stacked" | "dragOnSameLevel" | "overflow" | "onDragUpdate" | "onOrderChange" | "togglerClassName"> & Partial<Pick<Omit<NavigationProps, keyof ThemeProps>, "indentSize">> & Partial<Pick<Pick<NavigationProps, "indentSize">, never>> & import("amis-core/lib/theme").ThemeOutterProps): {
        ref: any; /**
         * 包裹导航的外层标签名，可以使用其他标签渲染
         * @default "ul"
         */
