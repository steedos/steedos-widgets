...
export function GlobalHeader({ navigation, selected, app }) {
  ...
  return (
    <>
      <Disclosure
        as="header"
        className="slds-global-header_container sticky top-0 z-40 w-full flex-none bg-white/80 shadow backdrop-blur transition-colors duration-500 lg:z-50 border-b lg:border-b-2 lg:border-sky-500"
      >
        {({ open }) => (
          <>
