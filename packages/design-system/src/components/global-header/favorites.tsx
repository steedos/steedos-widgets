 ...
 */
class GlobalHeaderFavorites extends React.Component<any> {
...
(GlobalHeaderFavorites as any).displayName = GLOBAL_HEADER_FAVORITES;

(GlobalHeaderFavorites as any).defaultProps = {
	assistiveText: {
...
(GlobalHeaderFavorites as any).propTypes = propTypes;
