 ...
 */
class GlobalHeaderNotifications extends React.Component<any> {
	render() {
...
(GlobalHeaderNotifications as any).displayName = GLOBAL_HEADER_NOTIFICATIONS;

(GlobalHeaderNotifications as any).defaultProps = {
	assistiveText: {
...
(GlobalHeaderNotifications as any).propTypes = propTypes;
