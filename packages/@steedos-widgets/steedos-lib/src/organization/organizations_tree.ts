...
export const organizationsTree = {
    ...
    getApiRequestAdaptor: function (api, context, option: any = {}) {
        ...
        if (searchableFilter.length > 0) {
            if (filters.length > 0) {
                filters = [filters, "and" as any, searchableFilter];
            } else {
    ...
    getApiAdaptor: function (payload, response, api, context, option: any = {}) {
