...
import {BaseSchema, SchemaClassName, SchemaCollection} from 'amis';

/** 容器拖拽配置 */
interface ContainerDraggableConfig {
  /**
...
class Container<T> extends React.Component<
  ContainerProps & T,
  object
> {
  ...
  render() {
    ...
    const contentDom = (
      <Component
        className={cx(
          'antd-Form antd-Form--horizontal steedos-amis-form Container',
...
//   type: 'container'
// })
export class SteedosObject extends Container<{}> {}
