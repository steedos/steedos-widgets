 ...
 * @LastEditTime: 2025-12-19 16:49:41
 * @Description: 
 */
import "./AmisSteedosField.less";
import { Field, getUISchema, getSelectMap, getPage } from '@steedos-widgets/amis-lib';
import { sampleSize, has, isArray, isEmpty, isString, pick, includes, clone, forEach, each, isObject, get, map, join } from 'lodash';
                            ...
                            "body": [
                                {
                                    ...
                                    "items": {
                                        "type": "tpl",
                                        "tpl": "<a href='/api/v6/files/download/cfs.files.filerecord/${_id}/${original.name|url_encode}' target='_blank'>${original.name}</a>"
                                    }
                                }
                            ]
                        }
