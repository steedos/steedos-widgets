                    ...
                    "body": [{
                      ...
                      "badge": {
                        ...
                        "style": {
                          ...
                          "border-radius": "10px",
                          "line-height": "18px",
                          "margin-left": "${value.${id}>9?(value.${id}>99?'-21px':'-11px'):'0'}",
                          "right": "auto",
                          "font-size": "16px"
                        }
                      }
    ...
    "body": [
      {
            ...
            "body": [
              {
                ...
                "badge": {
                  "visibleOn": "${value.workflow | toInt}",
                  "offset": [3, -3],
                  "style": {
                    "width": "8px",
                    "height": "8px"
        ...
        "api": {
          ...
          "adaptor": "if (payload.data.steedos_keyvalues.length > 0) {\n  payload.data.value = payload.data.steedos_keyvalues[0].value\n  for (i in payload.data.value){\n    if (payload.data.value[i] <= 0) {\n      delete payload.data.value[i]\n    }\n  }\n}\nreturn payload",
          "messages": {
          },
          "data": {
          ...
          "requestAdaptor": "var query = `{\n  steedos_keyvalues\n  (filters: [[\"user\",\"=\", \"`+ api.data.userId + `\"], [\"space\",\"=\", \"` + api.data.tenantId+`\"], [\"key\", \"=\", \"badge\"]])\n  {\n  value\n  }\n}`\napi.data = {}\napi.data.query=query\nreturn api;"
        }
      }
    ],
    "clearValueOnHidden": false,
