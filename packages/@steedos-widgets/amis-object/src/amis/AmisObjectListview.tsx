    ...
    body: [{
      ...
      body: [
        ...
        } : null,
        {
          ...
          "body": {
            type: "wrapper",
            className: `p-0 bg-white steedos-object-listview-content-wrapper flex flex-col ${(formFactor === 'SMALL')? '':'m-4 shadow rounded'} ${(displayAs === 'split')? 'mr-0 shadow-none border':''}`,
            body: [
