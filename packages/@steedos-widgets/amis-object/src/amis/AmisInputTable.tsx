 ...
 * @LastEditTime: 2023-12-22 18:26:44
 */
...
export const AmisInputTable = async (props) => {
  ...
  const { $schema, fields, name, id, data, columns, amis, className, tableClassName, headerToolbar, footerToolbar, inlineEditMode, strictMode, dialog } = props;
