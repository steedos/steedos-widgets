 ...
 * @LastEditTime: 2023-12-18 16:44:02
 */
...
export const AmisInputTable = async (props) => {
  ...
  const { $schema, fields, name, id, data, columns, amis, className, tableClassName, headerToolbar, footerToolbar, inlineEditMode, strictMode } = props;
