                              ...
                              pickerSchema: {
                                ...
                                columns: [
                                  ...
                                  },
                                  {
                                    ...
                                    type: "tpl",
                                    tpl: '<a target="_blank" href="/app/admin/queue_import/view/${_id}">${description}</a>',
                                  ...
                                  },
                                  {
                                    ...
                                    label: i18next.t('frontend_import_data_object_name'),
                                    type: "tpl",
                                    tpl: '<a target="_blank" href="/app/admin/${_display.object_name.objectName}/view/${_display.object_name.value}">${_display.object_name.label}</a>',
                                    className: "whitespace-nowrap",
                                    html: null,
                                  },
                                  {
