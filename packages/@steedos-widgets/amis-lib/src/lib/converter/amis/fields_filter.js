...
export async function getObjectFieldsFilterBarSchema(objectSchema, ctx) {
  ...
  const dataProviderInited = `
    ...
    if(_.isEmpty(defaultSearchableFields) && listView){
      const sFields = listView.searchable_fields;
  ...
  return {
    ...
    "body": {
      ...
      "body": {
        ...
        "style": isMobileFilter ? { "zIndex": 1000, "display": "flex", "flexDirection": "column", "overflowY": "auto", "height": "fit-content", "maxHeight": "calc(100vh - 32px)", "width": "920px", "maxWidth": "100%" } : undefined,
      },
      "size": "xs",
      "className": isMobileFilter ? "p-0 fixed inset-0 flex justify-center items-center" : "p-0",
      "style": isMobileFilter ? { "zIndex": 999, "backgroundColor": "rgba(0,0,0,0.4)", "padding": "16px" } : undefined,
