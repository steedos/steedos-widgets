    ...
    plugins: [
      ...
      }),
      {
          ...
          generateBundle(outputOptions, bundle) {
              ...
              const amisDev = JSON.stringify(assets, null, 4).replace(/https\:\/\/unpkg.com\/fullcalendar/g, "https://unpkg.steedos.cn/fullcalendar").replace(/\@\{\{version\}\}/g, ``).replace(/https\:\/\/unpkg.com/g, unpkgUrl)
              this.emitFile({
                 type: 'asset',
