...
export function RelatedList(props) {
    const { schema, object_name, foreign_key, app_id, record_id} = props;
    ...
    return (
        ...
        <div className="flex justify-between mb-1">
            ...
            <div className="flex flex-nowrap space-x-2 fill-slate-400">
                <RelatedListButtons foreign_key={foreign_key} record_id={record_id} refId={id} app_id={app_id} tab_id={object_name} schema={schema}></RelatedListButtons>
            </div>
        </div>
        {schema && <AmisRender
            id={id}
