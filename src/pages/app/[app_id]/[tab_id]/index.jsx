                  ...
                  <Listbox value={selectedListView} onChange={setSelectedListView}>
                    <div className="relative mt-1 w-[1/2]">
                      ...
                      <Transition
                        ...
                        leaveTo="opacity-0"
                      >
                        <Listbox.Options className="z-50 absolute mt-1 max-h-60 overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
